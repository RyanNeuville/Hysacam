  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Welcome to the CityReport Admin Panel</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border border-border">
          <CardHeader>
            ...
            <CardDescription>Monthly report submissions vs resolutions</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartData}>
                ...
                />
                <Bar dataKey="reports" fill="var(--color-primary)" name="Reports" />
                <Bar dataKey="resolved" fill="var(--color-secondary)" name="Resolved" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
